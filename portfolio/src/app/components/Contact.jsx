export default function Contact() {
  return (
    <article id="contact" className="scroll-mt-7 relative min-h-screen flex items-center justify-center overflow-hidden py-24">
      <div className="container">
        ...
        <div className="rounded-3xl bg-mainLight dark:bg-secondDark py-5">
          <div className="my-5 mx-auto w-3/4 sm:w-4/5 lg:w-2/3">
            <h2 className="text-2xl font-bold my-5 text-white dark:text-black">
